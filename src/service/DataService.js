...
export default class DataService extends React.Component {
    ...
    render() {
        return (
            <div style={{border: "solid 2px", width: "300px", align: "center"}}>
                ...
                <table align="center">
                    ...
                    <tr>
                        <td></td>
                        <td onClick={this.onSort.bind(this, 'first_name')}>sort</td>
                        <td onClick={this.onSort.bind(this, 'last_name')}>sort</td>
                    </tr>
